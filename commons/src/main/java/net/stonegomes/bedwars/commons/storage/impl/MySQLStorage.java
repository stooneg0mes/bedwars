package net.stonegomes.bedwars.commons.storage.impl;

import net.stonegomes.bedwars.commons.storage.SqlCredentials;
import net.stonegomes.bedwars.commons.storage.SqlStorage;
