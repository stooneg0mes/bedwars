...
public class WaitingFirstPositionCreatePhase implements ProcessPhase {

    @Override
    public String[] getStartMessage() {
        return new String[]{
            "",
            "§aGo to the §fwaiting first position§a and enter §f'done'§a on chat.",
    ...
    public BiPredicate<Object, Player> handleInput(ProcessContext context) {
        return (messageObject, player) -> {
            ...
            context.set("waitingFirstPosition", player.getLocation());
            return true;
        };
    }
